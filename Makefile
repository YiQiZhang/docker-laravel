...
webserver: base php7
	./nginx.sh $(WEBSERVER_DIR_NAME) $(WEBSERVER_DOCKER_ADDR) $(WEBSERVER_IMAGE) $(WEBSERVER_CONTAINER) $(WEBSERVER_LISTEN_PORT) $(WEBSERVER_LOG_DIR) $(APP_CONTAINER)	$(PHP_CONTAINER)

php7: base db cache
	./php7.sh $(PHP_DIR_NAME) $(PHP_DOCKER_ADDR) $(PHP_IMAGE) $(PHP_CONTAINER) $(PHP_LOG_PATH) $(APP_CONTAINER) $(MYSQL_CONTAINER) $(REDIS_CONTAINER)
